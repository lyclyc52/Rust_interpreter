...
export class RustLexer extends Lexer {
    ...
    public floatDotPossible():boolean{
        ...
        if(next == 'f') {
            // 1.f32
            if (String.fromCharCode(this._input.LA(2))=='3' && 
			String.fromCharCode(this._input.LA(3))=='2')return true;
            //1.f64
            if (String.fromCharCode(this._input.LA(2))=='6'&& 
			String.fromCharCode(this._input.LA(3))=='4')return true;
            return false;
        }
	...
	public static readonly ruleNames: string[] = [
		...
		"FLOAT_LITERAL", "INTEGER_SUFFIX", "FLOAT_SUFFIX", "FLOAT_EXPONENT", "OCT_DIGIT", 
		"DEC_DIGIT", "HEX_DIGIT", "LIFETIME_OR_LABEL", "PLUS", "MINUS", "STAR", 
